                <div class="headerLogo">
                    <a href="<?=$site_root?>home.php"><img src="<?=$site_root?>images/Logo.gif" alt="Grupo"/></a>
        ...
        <div class="headerNav">
			...
			<nav>
				<ul>
                <li><a href="<?=$site_root?>home.php" <? if($pagename == "home.php")echo ' style="color:#6989C6" '; ?>>Home</a></li>
